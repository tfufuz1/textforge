...
<div class="fixed bottom-5 right-5 z-50 flex flex-col space-y-2.5 max-w-md w-full pointer-events-none">
        ...
        >
            ...
            <div class="flex items-center space-x-2 shrink-0 self-center">
                {#if notification.action._tag === 'Some'}
                    ...
                    <button
                        class="px-2.5 py-1 text-xs font-bold bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg transition-all shadow-md shadow-indigo-600/20 active:scale-95"
                ...
                {/if}
                <button
                    class="p-1 rounded-lg text-slate-500 hover:text-slate-300 hover:bg-slate-800/80 transition-all text-xs"
                    title="Benachrichtigung schließe"
